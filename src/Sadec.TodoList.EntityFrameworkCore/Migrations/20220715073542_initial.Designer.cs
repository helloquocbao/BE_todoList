...
namespace Sadec.TodoList.Migrations
{
    ...
    [Migration("20220715073542_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sadec.TodoList.Tasks.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Sadec.TodoList.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Sadec.TodoList.Authorization.Users.User", null)
                        .WithMany("Claims")
